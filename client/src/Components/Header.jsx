  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 sm:mt-20 lg:px-44'>
        ...
        <div> 
            ...
            <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. <br className='max-md:hidden'/> Temporibus dolor facere perferendis nostrum pariatur hic ipsam esse dolores recusandae dolore.</p>
            <div>
